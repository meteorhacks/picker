...
PickerImp.prototype._dispatch = function(req, res, bypass) {
  ...
  function processNextMiddleware () {
    var middleware = self.middlewares[self.currentMiddleware++];
    if(middleware) {
  ...
  function processNextRoute () {
    var route = self.routes[self.currentRoute++];
    if(route) {
  ...
  function processNextSubRouter () {
    var subRouter = self.subRouters[self.currentSubRouter++];
    if(subRouter) {
